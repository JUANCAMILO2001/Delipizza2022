    ...
    <div id="wrapper">
            ...
            <div class="hero-title-wrap fl-wrap">
                <div class="container">
                    <div class="hero-title">
                        ...
                        <h2>Bienvenid@ a Delipizza <b style="color:#ffdb14;">{{auth()->user()->name}}</b>
                            <br>
        ...
        <div class="content">
            ...
            <section class="column-section no-padding hidden-section" data-scrollax-parent="true" id="sec4">
                <div class="column-wrap-bg left-wrap">
                    ...
                    <div class="quote-box">
                        ...
                        <div class="signature"><img src="./Restabook/images/signature.png" alt=""></div>
                        <br>
                ...
                <div class="column-section-wrap dark-bg" >
                    ...
                    <div class="illustration_bg">
                        <div class="bg"  data-bg="./Restabook/images/7.png"></div>
                    </div>
                </div>
            </section>
            ...
            <section class="parallax-section dark-bg hidden-section" data-scrollax-parent="true">
                ...
                <div class="brush-dec"></div>
                <div class="bg par-elem bg_tabs"  data-bg="https://i.pinimg.com/originals/29/48/3d/29483d95a01e53e376939bae351c2bbb.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                ...
                <div class="container">
                    <div class="section-title">
                        <h4>Ofertas especiales de menú.</h4>
                        <h2>Disfruta de las Mejores Especialidades de la Casa</h2>
                        <div class="dots-separator fl-wrap"><span></span></div>
                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="hero-menu_header fl-wrap">
                                    <ul class="tabs-menu     no-list-style change_bg">
                                        ...
                                        <li><a href="#tab-5" data-bgtab="https://restaurantepapos.com/wp-content/uploads/2021/01/MAZORCADAS.jpg"><span>05.</span>Mazorcada</a></li>
                                        <li><a href="#tab-6" data-bgtab="https://media.istockphoto.com/photos/homemade-italian-lasagna-with-tomato-sauce-and-chicken-served-with-picture-id1161228058?k=20&m=1161228058&s=612x612&w=0&h=1LUaUNnK3RsF58U0gOSoYcEBvHNLkodMphD6fAzECOM="><span>06.</span>Lasaña</a></li>
                                        <li><a href="#tab-7" data-bgtab="https://images.food52.com/-_c6yY9XZwopFUF-DAxDjgISz1s=/1200x900/8c7b4486-5bf1-4b55-b4ac-cce56d855c2b--2018-0413_grandma-claris-argentine-empanadas_3x2_james-ransoms-171.jpg"><span>07.</span>Empanadas</a></li>
                                        <li><a href="#tab-8" data-bgtab="https://www.lamansiondelasideas.com/wp-content/uploads/2022/04/bebida-adulterada-o-no.jpg"><span>08.</span>Gaseosas</a></li>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div id="tab-1" class="tab-content first-tab">
                                                ...
                                                <div class="hero-menu-item">
                                                    <div class="hero-menu-item-title fl-wrap">
                                                        <h6><span>01.</span>Pizza Hawaiana</h6>
                                                        <div class="hmi-dec"></div>
                                                        <span class="hero-menu-item-price">$25.000 COP</span>
                                                    </div>
                                                    <div class="hero-menu-item-details">
                                                        <p>Pizza Hawaiana grande con extra queso </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="hero-menu-item">
                                                    <div class="hero-menu-item-title fl-wrap">
                                                        <h6><span>02.</span>Pizza mexicana</h6>
                                                        <div class="hmi-dec"></div>
                                                        <span class="hero-menu-item-price">$25.000 COP</span>
                                                    </div>
                                                    <div class="hero-menu-item-details">
                                                ...
                                                <div class="hero-menu-item">
                                                    <div class="hero-menu-item-title fl-wrap">
                                                        <h6><span>03.</span>Pizza de Pollo con Champiñon</h6>
                                                        <div class="hmi-dec"></div>
                                                        <span class="hero-menu-item-price">$25.000 COP</span>
                                                    </div>
                                                    <div class="hero-menu-item-details">
                                                ...
                                                <div class="hero-menu-item">
                                                    <div class="hero-menu-item-title fl-wrap">
                                                        <h6><span>04.</span>Pizza de Carnes</h6>
                                                        <div class="hmi-dec"></div>
                                                        <span class="hero-menu-item-price">$25.000 COP</span>
                                                    </div>
                                                    <div class="hero-menu-item-details">
                                            ...
                                            <div class="tab">
                                                <div id="tab-2" class="tab-content">
                                                    ...
                                                    <div class="hero-menu-item">
                                                        <div class="hero-menu-item-title fl-wrap">
                                                            <h6><span>01.</span>Hamburguesa Especial Ahumada</h6>
                                                            <div class="hmi-dec"></div>
                                                            <span class="hero-menu-item-price">$15.000</span>
                                                        </div>
                                                        <div class="hero-menu-item-details">
                                                    ...
                                                    <div class="hero-menu-item">
                                                        <div class="hero-menu-item-title fl-wrap">
                                                            <h6><span>02.</span>Hamburgesa de Pollo Sensilla</h6>
                                                            <div class="hmi-dec"></div>
                                                            <span class="hero-menu-item-price">$14.500</span>
                                                        </div>
                                                        <div class="hero-menu-item-details">
                                                            <p>Etiam tempus felis eros, id lobortis turpis</p>
                                                        </div>
                                                    ...
                                                    <div class="hero-menu-item">
                                                        <div class="hero-menu-item-title fl-wrap">
                                                            <h6><span>03.</span>Hamburgesa de Res 180gr</h6>
                                                            <div class="hmi-dec"></div>
                                                            <span class="hero-menu-item-price">$14.000</span>
                                                        </div>
                                                        <div class="hero-menu-item-details">
                                                            <p>usce tempus tempus maximus volutpat</p>
                                                        </div>
                                                    ...
                                                    <div class="hero-menu-item">
                                                        <div class="hero-menu-item-title fl-wrap">
                                                            <h6><span>04.</span>Hmburguesa Doble carne de 180gr </h6>
                                                            <div class="hmi-dec"></div>
                                                            <span class="hero-menu-item-price">$18.500</span>
                                                        </div>
                                                        <div class="hero-menu-item-details">
                                                            <p>usce tempus tempus maximus volutpat</p>
                                                        </div>
            ...
            <div class="hero-title-wrap fl-wrap">
                <div class="container">
                    <div class="hero-title">
                        ...
                        <a href="{{route('register.index')}}" class="hero_btn">Registrate <i class="fal fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
